...
hs <- makeParamSet( 
         ...
         makeIntegerParam("min_data_in_leaf", lower=    4500L   , upper=  6500L),
         makeIntegerParam("num_leaves",       lower=   600L   , upper=  1024L),
...
PARAM$experimento  <- "HT7232_FE5_comp2"

PARAM$input$dataset       <- "./datasets/competencia2_2022_FE5_comp2.csv"
PARAM$input$training      <- c( 202103 )

PARAM$trainingstrategy$undersampling  <-  1.0   # un undersampling de 0.1  toma solo el 10% de los CONTINUA
PARAM$trainingstrategy$semilla_azar   <- 100019  #Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 111119  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
...
setwd("C:\\Users\\alfie\\OneDrive\\Documentos\\Maestria_DM\\Materias\\DMEyF_22\\")   #Establezco el Working Directory
