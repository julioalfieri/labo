...
AgregarVariables  <- function( dataset )
{
  ...
  #Cocientes
  dataset[ , cociente_1 := (ctrx_quarter/Visa_status) ]
  dataset[ , cociente_2 := (ctrx_quarter/mprestamos_personales) ]
  dataset[ , cociente_3 := (ctrx_quarter/ctarjeta_master_debitos_automaticos) ]
  dataset[ , cociente_4 := (ctrx_quarter/mcaja_ahorro) ]
  dataset[ , cociente_5 := (ctrx_quarter/mrentabilidad_annual) ]
  dataset[ , cociente_6 := (ctrx_quarter/mpayroll) ]
  dataset[ , cociente_7 := (ctrx_quarter/Master_msaldodolares) ]
  dataset[ , cociente_8 := (ctrx_quarter/ccaja_seguridad) ]
  dataset[ , cociente_9 := (ctrx_quarter/Master_fechaalta) ]
  dataset[ , cociente_10 := (ctrx_quarter/ccaja_seguridad) ]
  dataset[ , cociente_11 := (ctrx_quarter/ccallcenter_transacciones) ]
