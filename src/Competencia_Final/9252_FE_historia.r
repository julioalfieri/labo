...
TendenciaYmuchomas  <- function( dataset, cols, ventana=3, tendencia=TRUE, minimo=FALSE, maximo=FALSE, promedio=FALSE, 
...
CanaritosAsesinos  <- function( canaritos_ratio=0.2 )
{
  ...
  dataset[ , entrenamiento := foto_mes>= 202101 &  foto_mes<= 202107  & ( clase01==1 | azar < 0.10 ) ]
