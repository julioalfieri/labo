...
ksemilla_azar  <- c(100019) #100019, 110119, 111119, 111919, 900019
...
dir.create( "./exp/HT4110_100019/", showWarnings = FALSE )
setwd("./exp/HT4110_100019/")   #Establezco el Working Directory DEL EXPERIMENTO

#defino los archivos donde guardo los resultados de la Bayesian Optimization
archivo_log  <- "HT4110_100019.txt"
archivo_BO   <- "HT4110_100019.RDATA"
